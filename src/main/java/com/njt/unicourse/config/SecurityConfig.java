package com.njt.unicourse.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/courses").hasRole("STUDENT")
		...
		.antMatchers(HttpMethod.PUT, "/api/courses/**").hasRole("ADMIN")
		.antMatchers(HttpMethod.DELETE, "/api/courses/**").hasRole("ADMIN").and().httpBasic().and().csrf()
